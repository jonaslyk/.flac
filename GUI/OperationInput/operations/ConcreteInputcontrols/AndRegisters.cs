...
{
    class AndRegisters : BasicTwoRegistersControl
    {
        public AndRegisters (OperationSelector operationSelector)    : base(operationSelector)
        {

        }


        public AndRegisters(OperationSelector operationSelector, bool noSameRegisters)            : base(operationSelector, noSameRegisters)
        {
